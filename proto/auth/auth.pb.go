...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\"\xbb\x01\n" +
	...
	"\x06SignIn\x12\x13.auth.SignInRequest\x1a\x14.auth.SignInResponseB\x1bZ\x19diploma/proto/auth;authpbb\x06proto3"
